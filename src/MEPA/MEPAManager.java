...
public class MEPAManager {
    ...
    public void ENPR(String label, int k) throws IOException {
        writer.write(label + "  ENPR   " + k);
        writer.newLine();
    }
    ...
    public void NADA(String label) throws IOException {
        writer.write(label + "  NADA");
        writer.newLine();
    }
